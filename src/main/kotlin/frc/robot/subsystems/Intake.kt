...
object Intake : SubsystemBase() {
    ...
    val intakeMotor   = CANSparkMax(0,MotorType.kBrushed)   // todo, 775 brushed motor
    val conveyorMotor = CANSparkMax(0,MotorType.kBrushless) // todo, neo550 brushless motor
